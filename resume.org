...
- *Machine Learning & AI:* Python, R, PyTorch, Generative AI, LLMs, LangChain, NLP, Statistical Modeling, Hyperparameter Tuning
- *MLOps & Cloud:* GCP (Vertex AI, BigQuery, Looker, AlloyDB), Kubernetes (KFP), Docker, CI/CD, Jira, Airflow, Observability (Cloud Logger, Cloud Traces)
