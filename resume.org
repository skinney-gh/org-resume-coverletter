...
# ==============================================================================
# Setup fancy headers/footers for page numbers
...
** Sr Machine Learning Operations (MLOps) Engineer 
   :PROPERTIES:
   :COMPANY: Definity Financial
   :PERIOD: Jun 2022 - Present
   :LOCATION: Vancouver, Canada
   :END:
- Led the planning, development and maintenance of multiple analytical products from an MLOps perspective especially focused on Call Center AI applications, like agent assistance, call summarisation, topic modelling. 
