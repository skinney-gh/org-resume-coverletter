...
#+LATEX_HEADER: \newcommand{\resumevisatext}{No Sponsorship Required}
...
- *Machine Learning & AI:* Python, PyTorch, Generative AI, Large Language Models (LLMs), XGBoost
- *MLOps & Infrastructure:* Kubernetes (KFP), Docker, Vertex AI, CI/CD, Airflow, Model Deployment
- *Cloud & Data:* Google Cloud Platform (GCP), BigQuery, DuckDB, FastAPI, Data Modeling, Data Governance (Collibra)
- *Core Technologies:* Git, SQL, Bash, Linux, R, Java
...
** Machine Learning Operations (MLOps) Engineer 
   ...
   :END:
- Led the planning, development and maintenance of multiple analytical products introducing AI to Call Center applications eg: agent assistance, call summarisation, topic modelling reports for contact centers. 
- Developed and deployed statistical models, Generative AI *LLM API's, like call summarisation and  and rule-based systems on RStudio and Google Cloud, significantly enhancing business workflows and productivity at call centers and fraud detection.
...
- Engineered data pipelines powering self-serve applications for marketing campaign performance reports, reducing turnaround time by over 90% (7 hours)
- Analyzed large-scale application logs (25 GB+) using Python and Command line tools. Supported fixes and dpeloyments of a large Java code base includin SQL, Java and HTML in developing bug fixes
...
- Developed and negotiated proposals, cost estimations, and pricing strategies, ensuring clear purchase terms with diverse clients for a product line. This included 
...
- Proposed & engineered a *75% reduction* in runtime and 100% software license utilization improvement through a bespoke, python driven solution to schedule and prioritise computational model simulations.
- Developed automated model runs & reports, saving 30 minutes of analysis time, and 4+ hours of large data transfer per design iteration *(300+ hours/month)*.
