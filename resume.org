...
* Summary
Machine Learning Engineer with 13+ years bridging technical execution and business value across manufacturing, oil & gas, and financial services. Combines engineering design and technical sales background with ML expertise to translate stakeholder requirements into scalable AI products. Proven track record delivering production systems (GenAI/LLM) using GCP infrastructure while collaborating across Sales, Marketing, and Engineering teams.

* SKILLS

- *Machine Learning & AI:* Python, R, PyTorch, Generative AI, LLMs, XGBoost, Statistical Modeling, Hyperparameter Tuning
- *MLOps & Cloud:* GCP (Vertex AI, BigQuery, Looker), Kubernetes (KFP), Docker, CI/CD, Airflow, Observability (Cloud Logger, Cloud Traces)
...
** Machine Learning Operations (MLOps) Engineer
   ...
   :END:
- Lead developer of 3+ production AI products serving *160k+ LLM requests/day*, with Looker, Cloud Logger, and Cloud Traces for observability and monitoring.
- Built and maintained RAG-based live agent assistance solution with 15+ model variants, call summarization, and topic modeling systems processing *8k+ calls/day* across multiple GenAI products.
- Created reusable ML frameworks, CI/CD pipelines, and logging infrastructure that reduced development time by *200+ hours* while mentoring junior engineers on MLOps best practices.
